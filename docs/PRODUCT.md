# Documento de Producto — DasCash

**Versión:** 1.1  
**Fecha:** 2026-06-10  
**Estado:** MVP funcional + flujo de pago QR/Mercado Pago (Fase 1) — listo para demo
...
| Recuperación de contraseña (email)   | ✅ Implementado |
...
| Listado de tiendas (filtros, búsqueda, paginación) | ✅ Implementado |
| Detalle de tienda + registrar compra   | ✅ Implementado |
| Mis compras (historial paginado)       | ✅ Implementado |
| Mis causas / impacto acumulado         | ✅ Implementado |
| Scanner QR (cámara)                    | ✅ Implementado |
| Pagar a comercio con Mercado Pago (QR) | ✅ Implementado |
| Pantallas de resultado de pago (éxito / pendiente / fallido) | ✅ Implementado |
...
| Pantalla                                              | Estado          |
| ----------------------------------------------------- | --------------- |
| Gestión de merchants (crear, editar, eliminar, listar) | ✅ Implementado |
| Gestión de tiendas (crear, editar, eliminar, causas)  | ✅ Implementado |
| Gestión de campañas (crear, editar, eliminar, listar) | ✅ Implementado |
| Gestión de causas (crear, editar, eliminar, listar)   | ✅ Implementado |

### Limitaciones conocidas del MVP

| Limitación                                  | Impacto                                                         |
| ------------------------------------------- | --------------------------------------------------------------- |
| Paginación parcial                          | Stores y purchases paginan; merchants, campañas y causas aún no |
...
| Cashback virtual (MP Fase 1, sin split)     | El pago real va 100% al comercio; la donación se registra en la DB pero no se transfiere a la causa (requiere MP Marketplace — Fase 2) |
...
### Completado desde v1.0 (2026-04 → 2026-06)

- [x] Refresh automático de JWT en el frontend (interceptor de 401 con cola compartida)
- [x] Paginación en listados de tiendas y compras
- [x] Recuperación de contraseña por email (flujo completo frontend + backend)
- [x] CRUD completo para merchants, stores, campañas y causas en el panel admin
- [x] QR por tienda + pago con Mercado Pago Checkout Pro (Fase 1): scanner, checkout, webhook, cashback automático

### Sprint actual / inmediato

- [ ] Validación de firma del webhook de Mercado Pago (`x-signature`)
- [ ] Paginación en los listados restantes (merchants, campañas, causas, transacciones)
- [ ] Pantalla de Settings funcional (cambio de contraseña, notificaciones)

### Próximo (corto plazo)

- [ ] MP Marketplace (Fase 2): split automático de fondos 95/5 — liquidación real del cashback a las causas
